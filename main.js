...
function update() {
    ...
    players.player.KBText.setText('KB: ' + (players.player.KBmultiplier.toFixed(1) * 100) - 100);
    players.player2.KBText.setText('KB: ' + (players.player2.KBmultiplier.toFixed(1) * 100) - 100);
